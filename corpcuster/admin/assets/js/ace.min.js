...
function(a, b) {
        ...
        function c(b, c) {
                        ...
                        "POST" == i && "object" == typeof n && (p = a.extend({}, p, n)), a.ajax(p).error(function() {
                            ...
                            if ("function" == typeof h.settings.update_active) o = h.settings.update_active.call(null, c, b, i, m);
                                ...
                                if (q.length > 0) {
                                    ...
                                    o.closest("li").addClass("active").parents(".nav li").addClass("active oen");
            ...
            this.startLoading = function() {
                ...
                if (d && 0 != d.length) {
                    ...
                    h.settings.close_dropdowns && a(".dropdown.oen .dropdown-toggle").dropdown("toggle"), h.loadUrl(d, null, c)
                }
        ...
        function c(b, c) {
            ...
            this.show = function(b, c, d) {
                ...
                d && (j = !0), c = "undefined" != typeof c ? c : this.settings.duration, f.css({
                    ...
                    overflow: "hidden",
                    display: "block"
                }).removeClass("nav-hide").addClass("nav-show").parent().addClass("oen"), b.scrollTop = 0;
                var g = function(b, c) {
                ...
                f.css({
                    ...
                    overflow: "hidden",
                    display: "block"
                }).parent().removeClass("opn"), b.offsetHeight;
                var h = function(b, c) {
                    b && b.stopPropagation(), f.css({
                        display: "none",
                        overflow: "",
            ...
            o.call(f), a(window).on("resize.sidebar.vars", function() {
                ...
                if (d && 0 != d.length) {
                    ...
                    if (d.hasClass("dropdown-toggle")) {
                        ...
                        return k && f.settings.hide_open_subs && a(j).find("> .opn > .submenu").each(function() {
            ...
            if (f = l.find(".nav-list"), g = f.get(0)) {
                ...
                this.scroll_to_active = function() {
                        if (u && u.is_active()) try {
                            var a, b = o.vars(),
                                c = l.find(".nav-list");
                            b.minimized && !b.collapsible ? a = c.find("> .active") : (a = f.find("> .active.hover"), 0 == a.length && (a = f.find(".active:not(.opn)")));
                            var d = a.outerHeight();
                            c = c.get(0);
    ...
    function(a, b) {
        a("#ace-settings-btn").on(ace.click_event, function(b) {
            b.preventDefault(), a(this).toggleClass("open"), a("#ace-settings-box").toggleClass("opn")
            ...
            if (!a("#sidebar").hasClass("h-sidebar")) {
                if (this.checked) a("#sidebar li").addClass("hover").filter(".oen").removeClass("oen").find("> .submenu").css("display", "none");
                else {
