/**
 *
 * @license Guriddo jqGrid JS - v5.2.1 - 2017-07-07
...
! function(a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
            ...
            if (!this.grid) {
                ...
                var e = this,
                    f = {
                        ...
                        dragMove: function(a) {
                            if (this.resizing) {
                                var b, c, e = a.pageX - this.resizing.startX,
                ...
                $(x).attr({
                        id: "gbox_" + this.id,
                        dir: i
                    }).insertBefore(k), $(k).attr("id", "gview_" + this.id).appendTo(x), $("<div " + l(e.p.styleUI + ".common", "overlay", !1, "jqgrid-overlay") + " id='lui_" + this.id + "'></div>").insertBefore(k),
                    $("<div " + l(m, "loadingBox", !1, "loading") + " id='load_" + this.id + "'>" + $.jgrid.getRegional(e, "defaults.loadtext", this.p.loadtext) + "</div>").insertBefore(k), $(this).attr({
                        role: "presentation",
                ...
                var y, z = ["shiftKey", "altKey", "ctrlKey"],
                    ...
                    N = function(a, b, c, d) {
                        ...
                        if (g && (e.p.data = [], e.p._index = {}, e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            if (e.p.grouping && (U = !0 === e.p.groupingView.groupCollapse, N = $.jgrid.getMethod("groupingPrepare")), O > 0 && e.p.page <= 0 && (e.p.page = 1), L && O) {
                                d && (R *= d + 1);
                                for (var V = $.isFunction(e.p.afterInsertRow), W = z ? l(m, "rownumBox", !1, "jqgrid-rownum") : "", X = x ? l(m, "multiBox", !1, "cbox") : ""; P < O;) {
                                    ...
                                    if (D.push(""), z && D.push(G(0, P, e.p.page, e.p.rowNum, W)), x && D.push(F(u, z, P, !1, X)), y && D.push(p.call(v, x + z, P + b)), i.repeatitems) {
                                        ...
                                        for (k = 0; k < B.length; k++) o = $.jgrid.getXmlData(t, B[k]), C[e.p.colModel[k + x + y + z].name] = o, D.push(E(u, o, k + x + y + z, P + b, t, C));
                            ...
                            if (!0 === e.p.gridview && (n = e.p.treeANode > -1 ? e.p.treeANode : 0, e.p.grouping ? g || (v.jqGrid("groupingRender", Q, e.p.colModel.length, e.p.page, R), Q = null) : !0 === e.p.treeGrid && n > 0 ? $(e.rows[n]).after(D.join("")) : (T.append(D.join("")), e.grid.cols = e.rows[0].cells)), e.p.totaltime = new Date - f, D = null, !0 === e.p.subGrid) try {
                    ...
                    O = function(a, b, c, d) {
                        ...
                        if (a) {
                            ...
                            var R, S = parseInt(e.p.rowNum, 10),
                            ...
                            for (e.p.grouping && (Y = !0 === e.p.groupingView.groupCollapse, V = $.jgrid.getMethod("groupingPrepare")); n < t;) {
                                if (q = u[n], void 0 === (x = $.jgrid.getAccessor(q, v)) && ("number" == typeof v && null != e.p.colModel[v + C + D + K] && (x = $.jgrid.getAccessor(q, e.p.colModel[v + C + D + K].name)), void 0 === x && (x = T + n, 0 === B.length && g.cell))) {
                                    var ba = $.jgrid.getAccessor(q, g.cell) || q;
                                    x = null != ba && void 0 !== ba[v] ? ba[v] : x, ba = null
                                }
                            ...
                            if (!0 === e.p.gridview && (w = e.p.treeANode > -1 ? e.p.treeANode : 0, e.p.grouping ? j || (y.jqGrid("groupingRender", X, e.p.colModel.length, e.p.page, S), X = null) : !0 === e.p.treeGrid && w > 0 ? $(e.rows[w]).after(P.join("")) : (Z.append(P.join("")), e.grid.cols = e.rows[0].cells)), e.p.totaltime = new Date - f, P = null, !0 === e.p.subGrid) try {
                            ...
                            if (e.p.reccount = z, e.p.treeANode = -1, e.p.userDataOnFooter && y.jqGrid("footerData", "set", e.p.userData, !0), j && (e.p.records = t, e.p.lastpage = Math.ceil(t / S)), c || e.updatepager(!1, !0), j) {
                                for (; z < t && u[z];) {
                                    if (q = u[z], void 0 === (x = $.jgrid.getAccessor(q, v)) && ("number" == typeof v && null != e.p.colModel[v + C + D + K] && (x = $.jgrid.getAccessor(q, e.p.colModel[v + C + D + K].name)), void 0 === x && (x = T + z, 0 === B.length && g.cell))) {
                                        var da = $.jgrid.getAccessor(q, g.cell) || q;
                        ...
                        if ($.isArray(e.p.data)) {
                            ...
                            if ($.each(e.p.colModel, function() {
                                    if (d = this.sorttype || "text", p = this.index || this.name, "date" === d || "datetime" === d ? (this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? (c = this.formatoptions && this.formatoptions.srcformat ? this.formatoptions.srcformat : $.jgrid.getRegional(e, "formatter.date.srcformat"), f = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat : $.jgrid.getRegional(e, "formatter.date.newformat")) : c = f = this.datefmt || "Y-m-d", k[p] = {
                                        ...
                                        for (o = 0, n = q.groupField.length; o < n; o++) this.name === q.groupField[o] && (l[o] = k[p], m[o] = p);
                                    e.p.multiSort || j || p !== e.p.sortname || (h = p, j = !0)
                                }), e.p.multiSort && (h = u, i = v), e.p.treeGrid && e.p._sort) return void $(e).jqGrid("SortTree", h, e.p.sortorder, k[h].stype || "text", k[h].srcfmt || "");
                            var r = {
                                    eq: function(a) {
                                        return a.equals
                                    },
                            ...
                            if (e.p.treeGrid && "adjacency" === e.p.treeGridModel && (n = 0, h = null), e.p.grouping)
                                for (o = 0; o < n; o++) s.orderBy(m[o], q.groupOrder[o], l[o].stype, l[o].srcfmt);
                            ...
                            if ((e.p.search || e.p.resetsearch) && e.p.grouping && e.p.groupingView._locgr) {
                                ...
                                for (C = 0; C < y; C++) {
                                    if (E)
                                        for (D in e.p.userData) e.p.userData.hasOwnProperty(D) && (e.p.userData[D] += parseFloat(w[C][D] || 0));
                                    F.call($(e), w[C], C, x)
                                }
                            }
                        ...
                        if (!e.grid.hDiv.loading) {
                            ...
                            switch (b = e.p.datatype.toLowerCase()) {
                                ...
                                case "script":
                                    ...
                                    break;
                                case "xmlstring":
                                    if (R(), c = "string" != typeof e.p.datastr ? e.p.datastr : $.parseXML(e.p.datastr), !T(c, 200, null)) return void S();
                                    N(c), U(c, h);
                                    break;
                                case "jsonstring":
                                    if (R(), c = "string" == typeof e.p.datastr ? $.jgrid.parse(e.p.datastr) : e.p.datastr, !T(c, 200, null)) return void S();
                                    O(c), U(c, h);
                                    break;
                                case "local":
                                case "clientside":
                    ...
                    X = function(a, b) {
                        var c, d, f, g, h, j, k, o = "<td class='ui-pg-button " + n + "'><span class='ui-separator'></span></td>",
                            q = "",
                    ...
                    Y = function(a, b, c) {
                        var d, f = e.p.colModel,
                            g = e.p.frozenColumns ? b : e.grid.headers[a].el,
                            h = "";
                        $("span.ui-grid-ico-sort", g).addClass(n), $(g).attr("aria-selected", "false"), d = f[a].index || f[a].name, void 0 === c ? f[a].lso ? "asc" === f[a].lso ? (f[a].lso += "-desc", h = "desc") : "desc" === f[a].lso ? (f[a].lso += "-asc", h = "asc") : "asc-desc" !== f[a].lso && "desc-asc" !== f[a].lso || (f[a].lso = "") : f[a].lso = h = f[a].firstsortorder || "asc" : f[a].lso = h = c, h ? ($("span.s-ico", g).show(), $("span.ui-icon-" + h, g).removeClass(n), $(g).attr("aria-selected", "true")) : e.p.viewsortcols[0] || $("span.s-ico", g).hide();
                        var i = u.indexOf(d); - 1 === i ? (u.push(d), v.push(h)) : h ? v[i] = h : (v.splice(i, 1), u.splice(i, 1)), e.p.sortorder = "", e.p.sortname = "";
                        for (var j = 0, k = u.length; j < k; j++) j > 0 && (e.p.sortname += ", "), e.p.sortname += u[j], j !== k - 1 && (e.p.sortname += " " + v[j]);
                        e.p.sortorder = v[k - 1]
                    },
                    ...
                    ea = function(a, b, c, d) {
                        var f, g, h, i, j, k = e.p.colModel[a],
                            l = "",
                            m = "",
                            n = "",
                            o = "",
                    ...
                    ia = function(a, b, c) {
                        ...
                        var d, f, g = $(".ui-jqgrid-view").css("font-size") || "11px",
                ...
                for (e.p.colMenu && $("body").on("click", function(a) {
                    ...
                    }), this.p.id = this.id, -1 === $.inArray(e.p.multikey, z) && (e.p.multikey = !1), e.p.keyName = !1, j = 0; j < e.p.colModel.length; j++) y = "string" == typeof e.p.colModel[j].template ? null != $.jgrid.cmTemplate && "object" == typeof $.jgrid.cmTemplate[e.p.colModel[j].template] ? $.jgrid.cmTemplate[e.p.colModel[j].template] : {} : e.p.colModel[j].template, e.p.colModel[j] = $.extend(!0, {}, e.p.cmTemplate, y || {}, e.p.colModel[j]), !1 === e.p.keyName && !0 === e.p.colModel[j].key && (e.p.keyName = e.p.colModel[j].name, e.p.keyIndex = j);
                ...
                var ja, ka, la, ma, na, oa, pa, qa, ra, sa = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                    ta = "",
                    ua = "",
                    va = "";
                ...
                if ("horizontal" === e.p.viewsortcols[1] ? (ua = " ui-i-asc", va = " ui-i-desc") : "single" === e.p.viewsortcols[1] && (ua = " ui-single-sort-asc", va = " ui-single-sort-desc", ta = " style='display:none'", e.p.viewsortcols[0] = !1), ja = t ? "class='ui-th-div-ie'" : "", qa = "<span class='s-ico' style='display:none'>", qa += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + ua + " ui-sort-" + i + " " + n + " " + r + " " + l(m, "icon_asc", !0) + "'" + ta + "></span>", qa += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + va + " ui-sort-" + i + " " + n + " " + r + " " + l(m, "icon_desc", !0) + "'" + ta + "></span></span>", e.p.multiSort && e.p.sortname)
                ...
                if (e.p.disableClick = !1, $("th", Ba).each(function(a) {
                        ra = e.p.colModel[a], la = ra.width, void 0 === ra.resizable && (ra.resizable = !0), ra.resizable ? (ma = document.createElement("span"), $(ma).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + i).css("cursor", "col-resize"), $(this).addClass(e.p.resizeclass)) : ma = "", $(this).css("width", la + "px").prepend(ma), ma = null;
                        var b = "";
                        ...
                        var c = ra.name;
                        "cb" !== c && "subgrid" !== c && "rn" !== c && e.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"), ta && (e.p.multiSort ? e.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), ra.lso && $("div span.ui-icon-" + ra.lso, this).removeClass(n).css("display", "")) : ra.lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + ra.lso, this).removeClass(n).css("display", "")) : e.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === e.p.lastsort && $("div span.ui-icon-" + e.p.sortorder, this).removeClass(n).css("display", "")) : a === e.p.lastsort && "" !== e.p.sortname && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + e.p.sortorder, this).removeClass(n).css("display", ""))), e.p.footerrow && (Aa += "<td role='gridcell' " + B(a, 0, "", null, "", !1) + ">&#160;</td>")
                        ...
                        if (1 === f.length) {
                            ...
                            if ($(a.target).hasClass("colmenuspan")) {
                                ...
                                var j = $(this).offset(),
                                    k = j.left,
                                    l = j.top;
                                return "ltr" === e.p.direction && (k += $(this).outerWidth()), ia(i, k, l, f), void a.stopPropagation()
                            }
                ...
                var Da = $("<table " + l(m, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + e.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(sa),
                    Ea = !(!e.p.caption || !0 !== e.p.hiddengrid),
                    Fa = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>"),
                    Ga = "Bootstrap" !== e.p.styleUI || isNaN(e.p.height) ? 0 : 2;
                sa = null, f.hDiv = document.createElement("div"), f.hDiv.style.width = f.width - Ga + "px", f.hDiv.className = l(m, "headerDiv", !0, "ui-jqgrid-hdiv"), $(f.hDiv).append(Fa), $(Fa).append(Da), Da = null, Ea && $(f.hDiv).hide(), e.p.pager && ("string" == typeof e.p.pager ? "#" !== e.p.pager.substr(0, 1) && (e.p.pager = "#" + e.p.pager) : e.p.pager = "#" + $(e.p.pager).attr("id"), $(e.p.pager).css({
                    width: f.width + "px"
                ...
                $(e).before(f.hDiv).on({
                    click: function(a) {
                        ...
                        var c = $(na).filter(":enabled").hasClass("cbox"),
                            d = $(e).triggerHandler("jqGridBeforeSelectRow", [oa[0].id, a]);
                        if (d = !1 !== d && "stop" !== d, $.isFunction(e.p.beforeSelectRow)) {
                            var f = e.p.beforeSelectRow.call(e, oa[0].id, a);
                            !1 !== f && "stop" !== f || (d = !1)
                        }
                        if ("A" !== na.tagName && ("INPUT" !== na.tagName && "TEXTAREA" !== na.tagName && "OPTION" !== na.tagName && "SELECT" !== na.tagName || c))
                            if (Ha = oa[0].id, na = $(na).closest("tr.jqgrow>td"), na.length > 0 && (Ia = $.jgrid.getCellIndex(na)), !0 !== e.p.cellEdit) {
                                if (na.length > 0 && (Ja = $(na).closest("td,th").html(), $(e).triggerHandler("jqGridCellSelect", [Ha, Ia, Ja, a]), $.isFunction(e.p.onCellSelect) && e.p.onCellSelect.call(e, Ha, Ia, Ja, a)), d)
                    ...
                    dblclick: function(a) {
                        if (na = a.target, oa = $(na, e.rows).closest("tr.jqgrow"), 0 !== $(oa).length) {
                            ...
                            var b = $(e).triggerHandler("jqGridDblClickRow", [$(oa).attr("id"), Ha, Ia, a]);
                            return null != b ? b : $.isFunction(e.p.ondblClickRow) && null != (b = e.p.ondblClickRow.call(e, $(oa).attr("id"), Ha, Ia, a)) ? b : void 0
                        }
                    },
                    contextmenu: function(a) {
                        if (na = a.target, oa = $(na, e.rows).closest("tr.jqgrow"), 0 !== $(oa).length) {
                            e.p.multiselect || $(e).jqGrid("setSelection", oa[0].id, !0, a), Ha = oa[0].rowIndex, Ia = $.jgrid.getCellIndex(na);
                            var b = $(e).triggerHandler("jqGridRightClickRow", [$(oa).attr("id"), Ha, Ia, a]);
                            return null != b ? b : $.isFunction(e.p.onRightClickRow) && null != (b = e.p.onRightClickRow.call(e, $(oa).attr("id"), Ha, Ia, a)) ? b : void 0
                        }
                    }
                ...
                var Ka = r + " " + l(m, "icon_caption_open", !0),
                    La = r + " " + l(m, "icon_caption_close", !0);
                f.cDiv = document.createElement("div");
                var Ma = !0 === e.p.hidegrid ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + q + "' title='" + ($.jgrid.getRegional(e, "defaults.showhide", e.p.showhide) || "") + "' />").hover(function() {
                    Ma.addClass(p)
                }, function() {
                    Ma.removeClass(p)
                ...
                if ($(f.cDiv).append(Ma).append("<span class='ui-jqgrid-title'>" + e.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === i ? "-rtl" : "") + " " + l(m, "gridtitleBox", !0)), $(f.cDiv).insertBefore(f.hDiv), e.p.toolbar[0]) {
                    var Na = l(m, "customtoolbarBox", !0, "ui-userdata");
                ...
                if ($(f.hDiv).after(f.bDiv).mousemove(function(a) {
                    ...
                    var Pa = "onorientationchange" in window,
        ...
        resetSelection: function(a) {
            return this.each(function() {
                ...
                }), d.setHeadCheckBox(!1), d.p.selarrrow = [], d.p.selrow = null) : d.p.selrow && ($("#" + $.jgrid.jqID(d.p.id) + " tbody:first tr#" + $.jgrid.jqID(d.p.selrow)).removeClass(f).attr("aria-selected", "false"), c && $("#" + $.jgrid.jqID(d.p.selrow), "#" + $.jgrid.jqID(c)).removeClass(f),
                    d.p.onUnSelectRow && d.p.onUnSelectRow.call(d, d.p.selrow), d.p.selrow = null);
        ...
        addRowData: function(a, b, c, d) {
            ...
            var e, f, g, h, i, j, k, l, m, n, o, p, q, r = !1,
                s = "",
                t = "",
                u = "";
                    ...
                    if (g = h.p.colModel[b], "subgrid" !== (d = g.name) && "cb" !== d && "rn" !== d) {
                        ...
                        if (f.addClass("edit-cell " + i), $(h.rows[a]).addClass("selected-row " + j), !0 !== g.editable || !0 !== c || f.hasClass("not-editable-cell") || $.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b)) e = f.html().replace(/\&#160\;/gi, ""), $(h).triggerHandler("jqGridSelectCell", [h.rows[a].id, d, e, a, b]), $.isFunction(h.p.onSelectCell) && h.p.onSelectCell.call(h, h.rows[a].id, d, e, a, b);
                            ...
                            $.inArray(g.edittype, ["text", "textarea", "password", "select"]) > -1 && $(o).addClass(k), f.html("").append(o).attr("tabindex", "0"), $.jgrid.bindEv.call(h, o, n), window.setTimeout(function() {
                                $(o).focus()
                            }, 1), $("input, select, textarea", f).on("keydown", function(c) {
                        ...
                        h.p.iCol = b, h.p.iRow = a, h.p.iRowId = h.rows[a].id
                    }
                }
            })
        },
                    ...
                    if (null !== d) {
                        ...
                        if (h !== c.p.savedRow[d].v) {
                            ...
                            if (!0 === t[0]) {
                                ...
                                if ($("input.hasDatepicker", j).length > 0 && $("input.hasDatepicker", j).datepicker("hide"), "remote" === c.p.cellsubmit)
                                    if (c.p.cellurl) {
                                        var x = {};
            ...
            return this.each(function() {
                ...
                if (d.grid && !0 === d.p.cellEdit) {
                    for (c = b + 1; c < d.p.colModel.length; c++)
                        if (!0 === d.p.colModel[c].editable && (!$.isFunction(d.p.isCellEditable) || d.p.isCellEditable.call(d, d.p.colModel[c].name, a, c))) {
                            e = c;
                            break
                        }!1 !== e ? $(d).jqGrid("editCell", a, e, !0) : d.p.savedRow.length > 0 && $(d).jqGrid("saveCell", a, b)
                }
            })
        },
        ...
        hideModal: function(a, b) {
            ...
            if ($.fn.jqm && !0 === b.jqm) $(a).attr("aria-hidden", "true").jqmHide();
            else {
                if ("" !== b.gb) try {
        ...
        createModal: function(a, b, c, d, e, f, g) {
            ...
            if (c.resize)
                if ($.fn.jqResize) $(l).append("<div class='jqResize " + j.resizable + " " + k.icon_base + " " + j.icon_resizable + "'></div>"), $("#" + $.jgrid.jqID(a.themodal)).jqResize(".jqResize", !!a.scrollelm && "#" + $.jgrid.jqID(a.scrollelm));
                else try {
                    $(l).resizable({
                        handles: "se, sw",
                        alsoResize: !!a.scrollelm && "#" + $.jgrid.jqID(a.scrollelm)
                    })
                } catch (a) {}!0 === c.closeOnEscape && $(l).keydown(function(b) {
                    if (27 === b.which) {
        ...
        viewModal: function(a, b) {
            if (b = $.extend({
                    ...
                    jqm: !0,
                    jqM: !0
                }, b || {}), void 0 === b.focusField && (b.focusField = 0), "number" == typeof b.focusField && b.focusField >= 0 ? b.focusField = parseInt(b.focusField, 10) : "boolean" != typeof b.focusField || b.focusField ? b.focusField = 0 : b.focusField = !1, $.fn.jqm && !0 === b.jqm) b.jqM ? $(a).attr("aria-hidden", "false").jqm(b).jqmShow() : $(a).attr("aria-hidden", "false").jqmShow();
        ...
        createEl: function(a, b, c, d, e) {
            ...
            switch (a) {
                ...
                case "select":
                    ...
                    if (!0 === b.multiple ? (k = !0, g.multiple = "multiple", $(g).attr("aria-multiselectable", "true")) : k = !1, null != b.dataUrl) {
                        ...
                        if ("string" == typeof b.value)
                            for (p = b.value.split(w), o = 0; o < p.length; o++) q = p[o].split(v), q.length > 2 && (q[1] = $.map(q, function(a, b) {
                                if (b > 0) return a
                            }).join(v)), r = document.createElement("option"), r.setAttribute("role", "option"), r.value = q[0], r.innerHTML = q[1], g.appendChild(r), k || $.trim(q[0]) !== $.trim(c) && $.trim(q[1]) !== $.trim(c) || (r.selected = "selected"), k && ($.inArray($.trim(q[1]), l) > -1 || $.inArray($.trim(q[0]), l) > -1) && (r.selected = "selected");
                        else if ("[object Array]" === Object.prototype.toString.call(b.value))
                            for (s = b.value, o = 0; o < s.length; o++) 2 === s[o].length && (t = s[o][0], u = s[o][1], r = document.createElement("option"), r.setAttribute("role", "option"), r.value = t, r.innerHTML = u, g.appendChild(r), k || $.trim(t) !== $.trim(c) && $.trim(u) !== $.trim(c) || (r.selected = "selected"), k && ($.inArray($.trim(u), l) > -1 || $.inArray($.trim(t), l) > -1) && (r.selected = "selected"));
                ...
                default:
                    var A;
                    A = "button" === a ? "button" : "textbox", g = document.createElement("input"), g.type = a, g.value = c, f(g, b), "button" !== a && (d ? b.size || $(g).css({
                        width: "96%"
                    }) : b.size || (b.size = 20)), $(g).attr("role", A)
            }
            return g
        },
        ...
        checkValues: function(a, b, c, d) {
            ...
            if (e) {
                ...
                var n = !1 !== e.required;
                if (!0 === e.number && (!1 !== n || !$.jgrid.isEmpty(a)) && isNaN(a)) return [!1, g + ": " + m.number, ""];
                ...
                var o;
                if (!0 === e.email && !(!1 === n && $.jgrid.isEmpty(a) || (o = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, o.test(a)))) return [!1, g + ": " + m.email, ""];
                if (!0 === e.integer && (!1 !== n || !$.jgrid.isEmpty(a))) {
                    if (isNaN(a)) return [!1, g + ": " + m.integer, ""];
                    if (a % 1 != 0 || -1 !== a.indexOf(".")) return [!1, g + ": " + m.integer, ""]
                }
                if (!0 === e.date && !(!1 === n && $.jgrid.isEmpty(a) || (l[b].formatoptions && l[b].formatoptions.newformat ? (h = l[b].formatoptions.newformat, (j = $.jgrid.getRegional(k, "formatter.date.masks")) && j.hasOwnProperty(h) && (h = j[h])) : h = l[b].datefmt || "Y-m-d", $.jgrid.checkDate(h, a)))) return [!1, g + ": " + m.date + " - " + h, ""];
                if (!0 === e.time && !(!1 === n && $.jgrid.isEmpty(a) || $.jgrid.checkTime(a))) return [!1, g + ": " + m.date + " - hh:mm (am/pm)", ""];
                if (!0 === e.url && !(!1 === n && $.jgrid.isEmpty(a) || (o = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i, o.test(a)))) return [!1, g + ": " + m.url, ""];
                if (!0 === e.custom && (!1 !== n || !$.jgrid.isEmpty(a))) {
            ...
            if (!this.filter) {
                ...
                if (this.p.initFilter = $.extend(!0, {}, this.p.filter), c) {
                    ...
                    this.onchange = function() {
                        ...
                        if (w)
                            for (v = 0; v < e.p.columns.length; v++) e.p.columns[v].inlist && (e.p.columns[v].search = !0);
                        if (void 0 !== a.rules)
                            for (c = 0; c < a.rules.length; c++)
                                if (f.append(this.createTableRowForRule(a.rules[c], a)), w) {
                        ...
                        var z = $("<select class='selectopts " + h.srSelect + "'></select>");
                        ...
                        var b, c, e, f = "",
                            g = "",
                            h = ["int", "integer", "float", "number", "currency"];
        ...
        filterRefactor: function(a) {
            var b, c, d, e, f, g = {};
            try {
                if (g = "string" == typeof a.ruleGroudp ? $.jgrid.parse(a.ruleGroup) : a.ruleGroup, g.rules && g.rules.length)
                    for (b = g.rules, c = 0; c < b.length; c++) d = b[c], $.inArray(d.filed, a.ssfield) && (e = d.data.split(a.splitSelect), e.length > 1 && (void 0 === g.groups && (g.groups = []), f = {
                    ...
                    var d, e, f, g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
                        ...
                        j = function() {
                            ...
                            $.each(c.p.colModel, function() {
                                var m = $("#gs_" + c.p.idPrefix + $.jgrid.jqID(this.name), !0 === this.frozen && !0 === c.p.frozenColumns ? c.grid.fhDiv : c.grid.hDiv);
                                if (d = this.index || this.name, f = this.searchoptions || {}, e = a.searchOperators && f.searchOperMenu ? m.parent().prev().children("a").attr("soper") || a.defaultSearch : f.sopt ? f.sopt[0] : "select" === this.stype ? "eq" : a.defaultSearch, b = "custom" === this.stype && $.isFunction(f.custom_value) && m.length > 0 ? f.custom_value.call(c, m, "get") : m.val(), "select" === this.stype && f.multiple && $.isArray(b) && b.length && (j = !0, k.push(d), b = 1 === b.length ? b[0] : b), "bt" === e && (l = !0), b || "nu" === e || "nn" === e) g[d] = b, i[d] = e, h++;
                                else try {
                            ...
                            if (!0 === a.stringResult || "local" === c.p.datatype || !0 === a.searchOperators) {
                                var n = '{"groupOp":"' + a.groupOp + '","rules":[',
                                    o = 0;
                                $.each(g, function(a, b) {
                                    o > 0 && (n += ","), n += '{"field":"' + a + '",', n += '"op":"' + i[a] + '",', b += "", n += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', o++
                                }), n += "]}";
                                var p, q, r, s, t, u, v;
                                if (j && $.jgrid.filterRefactor({
                                    ...
                                    }), l && ($.isPlainObject(p) || (p = $.jgrid.parse(n)), p.rules && p.rules.length))
                                    for (q = p.rules, r = 0; r < q.length; r++) t = q[r], "bt" === t.op && (u = t.data.split("..."), u.length > 1 && (void 0 === p.groups && (p.groups = []), v = {
                                        groupOp: "AND",
                                        groups: [],
                                        rules: []
                                    }, p.groups.push(v), $.each(u, function(a) {
                                        var b = 0 === a ? "ge" : "le";
                                        (s = u[a]) && v.rules.push({
                                            data: u[a],
                                            op: b,
                                ...
                                (l || j) && (n = JSON.stringify(p)), $.extend(c.p.postData, {
                                    filters: n
                            ...
                            var w;
                            a.url && (w = c.p.url, $(c).jqGrid("setGridParam", {
                                url: a.url
                            }));
                            var x = "stop" === $(c).triggerHandler("jqGridToolbarBeforeSearch");
                            !x && $.isFunction(a.beforeSearch) && (x = a.beforeSearch.call(c)), x || $(c).jqGrid("setGridParam", {
                                search: m
                            }).trigger("reloadGrid", [{
                                page: 1
                            }]), w && $(c).jqGrid("setGridParam", {
                                url: w
                        ...
                        k = function(b) {
                            ...
                            var j;
                            a.url && (j = c.p.url, $(c).jqGrid("setGridParam", {
                                url: a.url
                            }));
                        ...
                        m = function(b, d, e) {
                            ...
                            for (var f, i, k = $(".ui-jqgrid-view").css("font-size") || "11px", l = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + k + ";left:" + d + "px;top:" + e + 'px;">', m = $(b).attr("soper"), n = [], o = 0, p = $(b).attr("colname"), q = c.p.colModel.length; o < q && c.p.colModel[o].name !== p;) o++;
        ...
        refreshFilterToolbar: function(a) {
            return a = $.extend(!0, {
                ...
                function b(e) {
                    if (e && e.rules) {
                        for (f = e.rules, k = f.length, c = 0; c < k; c++) g = f[c], -1 !== (h = $.inArray(g.field, l)) && (d = $("#gs_" + i.p.idPrefix + $.jgrid.jqID(j[h].name)), d.length > 0 && ("select" === j[h].stype ? d.find("option[value='" + $.jgrid.jqID(g.data) + "']").prop("selected", !0) : "text" === j[h].stype && d.val(g.data), $.isFunction(a.onSetVal) && a.onSetVal.call(i, d, j[h].name)));
                        if (e.groups)
                            for (var m = 0; m < e.groups.length; m++) b(e.groups[m])
                    }
                }
                var c, d, e, f, g, h, i = this,
                    j = i.p.colModel,
                    k = i.p.colModel.length,
                    l = [];
                if (i.p.filterToolbar) {
                    for (c = 0; c < k; c++) {
                        switch (l.push(j[c].name), d = $("#gs_" + i.p.idPrefix + $.jgrid.jqID(j[c].name)), j[c].stype) {
                            case "select":
                            case "text":
                                d.val("")
                        }
                        $.isFunction(a.onClearVal) && a.onClearVal.call(i, d, j[c].name)
                    }
                    "string" == typeof a.filters && a.filters.length && (e = $.jgrid.parse(a.filters)), $.isPlainObject(e) && b(e)
                }
            })
        },
        searchGrid: function(a) {
            ...
            return a = $.extend(!0, {
                ...
                if (c.grid) {
                    ...
                    if (a.styleUI = c.p.styleUI, "string" == typeof i && (i = $.jgrid.parse(i)), !0 === a.recreateFilter && $("#" + $.jgrid.jqID(h.themodal)).remove(), void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0]) b($("#fbox_" + $.jgrid.jqID(c.p.id)));
                    else {
                        ...
                        if (a.showQuery && (t = "<a id='" + e + "_query' class='fm-button " + k.button + " fm-button-icon-left'><span class='" + k.icon_base + " " + j.icon_query + "'></span>Query</a>"), a.columns.length ? (q = a.columns, w = 0, o = q[0].index || q[0].name) : $.each(q, function(a, b) {
                            ...
                            var z = "eq";
                            w >= 0 && q[w].searchoptions && q[w].searchoptions.sopt ? z = q[w].searchoptions.sopt[0] : a.sopt && a.sopt.length && (z = a.sopt[0]), i = {
                                groupOp: "AND",
                                rules: [{
                                    field: o,
                                    op: z,
                        ...
                        v = !1, a.tmplNames && a.tmplNames.length && (v = !0, u = "<tr><td class='ui-search-label'>" + a.tmplLabel + "</td>", u += "<td><select class='ui-template " + j.srSelect + "'>", u += "<option value='default'>Default</option>", $.each(a.tmplNames, function(a, b) {
                            ...
                            id: c.p.id
                        }), l.append(p), v && a.tmplFilters && a.tmplFilters.length && $(".ui-template", l).on("change", function() {
                            var b = $(this).val();
                            return "default" === b ? $("#" + e).jqFilter("addFilter", i) : $("#" + e).jqFilter("addFilter", a.tmplFilters[parseInt(b, 10)]), !1
                        }), !0 === a.multipleGroup && (a.multipleSearch = !0), $(c).triggerHandler("jqGridFilterInitialize", [$("#" + e)]), $.isFunction(a.onInitializeSearch) && a.onInitializeSearch.call(c, $("#" + e)), a.gbox = "#gbox_" + e, a.layer ? $.jgrid.createModal(h, l, a, "#gview_" + $.jgrid.jqID(c.p.id), $("#gbox_" + $.jgrid.jqID(c.p.id))[0], "#" + $.jgrid.jqID(a.layer), {
                            position: "relative"
                            ...
                            return c.p.search = !0, $.extend(c.p.postData, i), g = $(c).triggerHandler("jqGridFilterSearch"), void 0 === g && (g = !0), g && $.isFunction(a.onSearch) && (g = a.onSearch.call(c, c.p.filters)), !1 !== g && $(c).trigger("reloadGrid", [{
                                page: 1
                            ...
                            var b = {},
                                d = $("#" + e);
                            return c.p.search = !1, c.p.resetsearch = !0, !1 === a.multipleSearch ? b[a.sField] = b[a.sValue] = b[a.sOper] = "" : b[a.sFilter] = "", d[0].resetFilter(), v && $(".ui-template", l).val("default"), $.extend(c.p.postData, b), g = $(c).triggerHandler("jqGridFilterReset"), void 0 === g && (g = !0), g && $.isFunction(a.onReset) && (g = a.onReset.call(c)), !1 !== g && $(c).trigger("reloadGrid", [{
                                page: 1
        ...
        filterInput: function(a, b) {
            return b = $.extend(!0, {
                ...
                var c = this;
                if (c.grid) {
                    var d, e, f, g = '{"groupOp":"' + b.groupOp + '","rules":[',
                        h = 0;
                    if (a += "", "local" === c.p.datatype) {
                        ...
                        }), g += "]}", $.extend(c.p.postData, {
                            filters: g
                        }), $.each(["searchField", "searchString", "searchOper"], function(a, b) {
                            c.p.postData.hasOwnProperty(b) && delete c.p.postData[b]
                        });
                        var i = "stop" === $(c).triggerHandler("jqGridFilterInputBeforeSearch");
                        !i && $.isFunction(b.beforeSearch) && (i = b.beforeSearch.call(c)), i || $(c).jqGrid("setGridParam", {
                            search: !0
                        }).trigger("reloadGrid", [{
                            page: 1
                        }]), $(c).triggerHandler("jqGridFilterInputAfterSearch"), $.isFunction(b.afterSearch) && b.afterSearch.call(c)
                    }
                }
            })
        }
    ...
    if ($.jgrid.extend({
            editGridRow: function(a, b) {
                ...
                return b = $.extend(!0, {
                    ...
                    function d(a, b, c, d) {
                        ...
                        if ("_empty" !== a && (p = $(b).jqGrid("getInd", a)), $(b.p.colModel).each(function(l) {
                                if (f = this.name, g = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, j = g ? "style='display:none'" : "", "cb" !== f && "subgrid" !== f && !0 === this.editable && "rn" !== f) {
                                    if (!1 === p) i = "";
                                    else if (f === b.p.ExpandColumn && !0 === b.p.treeGrid) i = $("td[role='gridcell']:eq(" + l + ")", b.rows[p]).text();
                                    else {
                                        try {
                    ...
                    function g(a, b, c) {
                        ...
                        l && ($('td[role="gridcell"]', l).each(function(f) {
                            if ("cb" !== (d = k[f].name) && "subgrid" !== d && "rn" !== d && !0 === k[f].editable) {
                                if (d === b.p.ExpandColumn && !0 === b.p.treeGrid) e = $(this).text();
                                else try {
                    ...
                    function i() {
                        ...
                        o && "object" == typeof o && (s = o), $.isFunction(rp_ge[q.p.id].beforeCheckValues) && (o = rp_ge[q.p.id].beforeCheckValues.call(q, s, $(w), u)) && "object" == typeof o && (s = o);
                        for (e in s)
                            if (s.hasOwnProperty(e) && (l = $.jgrid.checkValues.call(q, s[e], e), !1 === l[0])) break;
                            ...
                            var t = $.extend({
                                ...
                                complete: function(e, h) {
                                    ...
                                    if ($("#sData", y + "_2").removeClass(f.active), s[c] = q.p.idPrefix + s[c], e.status >= 300 && 304 !== e.status ? (l[0] = !1, l[1] = $(q).triggerHandler("jqGridAddEditErrorTextFormat", [e, u]), $.isFunction(rp_ge[q.p.id].errorTextFormat) ? l[1] = rp_ge[q.p.id].errorTextFormat.call(q, e, u) : l[1] = h + " Status: '" + e.statusText + "'. Error code: " + e.status) : (l = $(q).triggerHandler("jqGridAddEditAfterSubmit", [e, s, u]), void 0 === l && (l = [!0, "", ""]), l[0] && $.isFunction(rp_ge[q.p.id].afterSubmit) && (l = rp_ge[q.p.id].afterSubmit.call(q, e, s, u))), !1 === l[0]) $(".FormError", w).html(l[1]), $(".FormError", w).show();
                                            ...
                                            a = null
                                        }, 500)), (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && ($(w).data("disabled", !1), "_empty" !== q.p.savedData[q.p.id + "_id"]))
                                        for (j in q.p.savedData) q.p.savedData.hasOwnProperty(j) && s[j] && (q.p.savedData[j] = s[j]);
                    ...
                    if (q.grid && a) {
                        ...
                        if (D ? (G = o(rp_ge[$(this)[0].p.id].template), r = y) : (G = $("<table id='" + x + "' class='EditTable ui-common-table'><tbody></tbody></table>"), r = y + "_2"), w = "#" + $.jgrid.jqID(w), $(J).append("<div class='FormError " + f.error + "' style='display:none;'></div>"), $(J).append("<div class='tinfo topinfo'>" + rp_ge[q.p.id].topinfo + "</div>"), $(q.p.colModel).each(function() {
                            ...
                            var T = !1;
                            !0 === b.closeOnEscape && (b.closeOnEscape = !1, T = !0);
                            var U;
                ...
                return b = $.extend(!0, {
                    ...
                    if (j.grid && a) {
                        ...
                        if ($(j.p.colModel).each(function() {
                            ...
                            var E = $("<div></div>").append(v).append("<table border='0' class='EditTable' id='" + m + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + b.labelswidth + "'>" + (x ? B + A : A + B) + "</td><td class='EditButton'>" + C + "</td></tr></tbody></table>");
                            $.jgrid.createModal(p, E, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(j.p.id), $("#gview_" + $.jgrid.jqID(j.p.id))[0]), x && ($("#pData, #nData", "#" + m + "_2").css("float", "right"), $(".EditButton", "#" + m + "_2").css("text-align", "left")), b.viewPagerButtons || $("#pData, #nData", "#" + m + "_2").hide(), E = null, $("#" + p.themodal).keydown(function(a) {
                                ...
                                $("#FormError", "#" + m).hide();
                                var a = i();
                                return -1 !== a[0] && a[1][a[0] - 1] && ($(j).triggerHandler("jqGridViewRowClickPgButtons", ["prev", $("#" + l), npos[1][npos[0]]]), $.isFunction(b.onclickPgButtons) && b.onclickPgButtons.call(j, "prev", $("#" + l), a[1][a[0]]), g(a[1][a[0] - 1], j), $(j).jqGrid("setSelection", a[1][a[0] - 1]), $(j).triggerHandler("jqGridViewRowAfterClickPgButtons", ["prev", $("#" + l), npos[1][npos[0] - 1]]), $.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons.call(j, "prev", $("#" + l), a[1][a[0] - 1]), h(a[0] - 1, a)), c(), !1
                            });
                            var F = i();
                            h(F[0], F)
                        }
            ...
            delGridRow: function(a, b) {
                ...
                return b = $.extend(!0, {
                    ...
                    var c = this;
                    if (c.grid && a) {
                        var d, g, h, i, j = c.p.id,
                            k = {},
                            l = !0,
                            m = "DelTbl_" + $.jgrid.jqID(j),
                            n = "DelTbl_" + j,
                            o = {
                                themodal: "delmod" + j,
                                modalhead: "delhd" + j,
                        ...
                        if (rp_ge[c.p.id].styleUI = c.p.styleUI || "jQueryUI", $.isArray(a) && (a = a.join()), void 0 !== $("#" + $.jgrid.jqID(o.themodal))[0]) {
                            ...
                            if (r += "<table class='EditTable ui-common-table' id='" + m + "_2'><tbody><tr><td><hr class='" + f.content + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + s + "&#160;" + t + "</td></tr></tbody></table>", b.gbox = "#gbox_" + $.jgrid.jqID(j), $.jgrid.createModal(o, r, rp_ge[c.p.id], "#gview_" + $.jgrid.jqID(c.p.id), $("#gview_" + $.jgrid.jqID(c.p.id))[0]), $(".fm-button", "#" + m + "_2").hover(function() {
                                    $(this).addClass(f.hover)
                                }, function() {
                                    $(this).removeClass(f.hover)
                                    ...
                                    if (k = {}, k = $(c).triggerHandler("jqGridDelRowClickSubmit", [rp_ge[c.p.id], l]), void 0 === k && $.isFunction(rp_ge[c.p.id].onclickSubmit) && (k = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], l) || {}), e = $(c).triggerHandler("jqGridDelRowBeforeSubmit", [l]), void 0 === e && (e = [!0, "", ""]), e[0] && $.isFunction(rp_ge[c.p.id].beforeSubmit) && (e = rp_ge[c.p.id].beforeSubmit.call(c, l)), e[0] && !rp_ge[c.p.id].processing) {
                                        ...
                                        var n = $.extend({
                                            ...
                                            complete: function(a, g) {
                                                var h;
                                                if ($("#dData", "#" + m + "_2").removeClass(f.active), a.status >= 300 && 304 !== a.status ? (e[0] = !1, e[1] = $(c).triggerHandler("jqGridDelRowErrorTextFormat", [a]), $.isFunction(rp_ge[c.p.id].errorTextFormat) && (e[1] = rp_ge[c.p.id].errorTextFormat.call(c, a)), void 0 === e[1] && (e[1] = g + " Status: '" + a.statusText + "'. Error code: " + a.status)) : (e = $(c).triggerHandler("jqGridDelRowAfterSubmit", [a, d]), void 0 === e && (e = [!0, "", ""]), e[0] && $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d))), !1 === e[0]) $("#DelError>td", "#" + m).html(e[1]), $("#DelError", "#" + m).show();
                                                else {
                                                    if (rp_ge[c.p.id].reloadAfterSubmit && "local" !== c.p.datatype) $(c).trigger("reloadGrid");
                                                        ...
                                                        if (!0 === c.p.treeGrid) try {
                                                            ...
                                                            for (h = 0; h < l.length; h++) $(c).jqGrid("delRowData", c.p.idPrefix + l[h]);
                                        ...
                                        if (n.url || rp_ge[c.p.id].useDataProxy || ($.isFunction(c.p.dataProxy) ? rp_ge[c.p.id].useDataProxy = !0 : (e[0] = !1, e[1] += " " + $.jgrid.getRegional(c, "errors.nourl"))), e[0])
                ...
                return b = $.extend({
                    ...
                    if (!this.p.navGrid) {
                        ...
                        if (o.grid && "string" == typeof a) {
                            ...
                            for (m.cloneToTop && o.p.toppager && (q = 2), p = 0; p < q; p++) {
                                ...
                                }).hover(r, s), f.showOnLoad && !0 === f.showOnLoad && $(t, w).click(), t = null), m.refresh && (t = $("<td class='ui-pg-button " + k.cornerall + "'></td>"), $(t).append("<div class='ui-pg-div'><span class='" + k.icon_base + " " + m.refreshicon + "'></span>" + m.refreshtext + "</div>"), $("tr", w).append(t), $(t, w).attr({
            ...
            groupingToggle: function(a) {
                return this.each(function() {
                    ...
                    var f, g, h, i = d.join("_"),
                        j = c.minusicon,
                        k = c.plusicon,
                        l = $("#" + $.jgrid.jqID(a)),
                        m = l.length ? l[0].nextSibling : null,
                        n = $("#" + $.jgrid.jqID(a) + " span.tree-wrap-" + b.p.direction),
                        o = function(a) {
                        ...
                        p = !1,
                        q = !1,
                        r = !!b.p.frozenColumns && b.p.id + "_frozen",
                        s = !!r && $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(r)),
                        t = s && s.length ? s[0].nextSibling : null;
                    if (n.hasClass(j)) {
                        if (m)
                            for (; m && !(void 0 !== (f = o(m.className)) && f <= e);) h = parseInt($(m).attr("jqfootlevel"), 10), q = !isNaN(h) && (c.showSummaryOnHide && h <= e), q || $(m).hide(), m = m.nextSibling, r && (q || $(t).hide(), t = t.nextSibling);
                        ...
                        for (h = f; h < b; h++) {
                            ...
                            $.each(i.summary, function() {
                                if (this.nm === k[h].name) {
                                    ...
                                    return n = "<td " + j.formatCol(h, 1, "") + ">" + $.jgrid.template(o, g, i.cnt, i.dataIndex, i.displayValue) + "</td>", !1
                                }
                            }), m += n
                        }
                        return m
                        ...
                        if (v = $.isFunction(k.groupText[u.idx]) ? k.groupText[u.idx].call(j, i, u.cnt, u.summary) : $.jgrid.template(k.groupText[u.idx], i, u.cnt, u.summary), "string" != typeof v && "number" != typeof v && (v = i), "header" === k.groupSummaryPos[u.idx] ? (l += '<tr id="' + g + '"' + (k.groupCollapse && u.idx > 0 ? ' style="display:none;" ' : " ") + 'role="row" class= "' + q.content + " jqgroup ui-row-" + j.p.direction + " " + h + '"><td style="padding-left:' + 12 * u.idx + 'px;"' + r + ">" + m + v + "</td>", l += f(e, 0, k.groups, !1 === k.groupColumnShow[u.idx] ? "" === r ? 2 : 3 : "" === r ? 1 : 2), l += "</tr>") : l += '<tr id="' + g + '"' + (k.groupCollapse && u.idx > 0 ? ' style="display:none;" ' : " ") + 'role="row" class= "' + q.content + " jqgroup ui-row-" + j.p.direction + " " + h + '"><td style="padding-left:' + 12 * u.idx + 'px;" colspan="' + (!1 === k.groupColumnShow[u.idx] ? b - 1 : b) + '">' + m + v + "</td></tr>", p - 1 === u.idx) {
                            ...
                            if ("header" !== k.groupSummaryPos[u.idx]) {
                                ...
                                for (x = 0; x < s; x++)
                                    if (t[x]) {
                                        var D = "";
                                        k.groupCollapse && !k.showSummaryOnHide && (D = ' style="display:none;"'), l += "<tr" + D + ' jqfootlevel="' + (u.idx - x) + '" role="row" class="' + q.content + " jqfoot ui-row-" + j.p.direction + '">', l += f(e, x, k.groups, 0), l += "</tr>"
                                    }
                                s = C
                            }
                        }
            ...
            setGroupHeaders: function(a) {
                return a = $.extend({
                    ...
                    for ($(p).prepend(w), d = $("<tr>", {
                            role: "row"
                        }).addClass("ui-jqgrid-labels jqg-third-row-header"), b = 0; b < s; b++)
                        if (f = t[b].el, g = $(f), c = r[b], h = {
                                ...
                                role: "gridcell"
                            }).css(h).addClass("ui-first-th-" + p.p.direction).appendTo(x), f.style.width = "", (i = A(c.name, a.groupHeaders)) >= 0) {
            ...
            destroyGroupHeader: function(a) {
                return void 0 === a && (a = !0), this.each(function() {
                    var b, c, d, e, f, g, h, i = this,
                        ...
                        l = i.p.colModel;
                    if (j) {
                        for ($(this).off(".setGroupHeaders"), b = $("<tr>", {
                                role: "row"
                            }).addClass("ui-jqgrid-labels"), e = j.headers, c = 0, d = e.length; c < d; c++) {
                        ...
                        $(k).children("tr.ui-jqgrid-labels").remove(), $(k).prepend(b), !0 === a && $(i).jqGrid("setGridParam", {
                            groupHeader: null
                        })
                    }
                })
                ...
                if (c = $.extend({
                    ...
                    if (b) {
                        ...
                        if ((d = $.jgrid.parseFunc(b)) && "object" === $.type(d)) {
                            ...
                            var l = $("#" + a).jqGrid(d);
                            if (c.restoreData && "" !== $.trim(f) && l.append(f), l.jqGrid("setGridParam", k), d.storeNavOptions && d.navGrid && (l[0].p.navGrid = !1, l.jqGrid("navGrid", d.pager, d.navOptions, d.editOptions, d.addOptions, d.delOptions, d.searchOptions, d.viewOptions), d.navButtons && d.navButtons.length))
                                for (var m = 0; m < d.navButtons.length; m++) "sepclass" in d.navButtons[m][1] ? l.jqGrid("navSeparatorAdd", d.navButtons[m][0], d.navButtons[m][1]) : l.jqGrid("navButtonAdd", d.navButtons[m][0], d.navButtons[m][1]);
                            ...
                            if (d.treeGrid)
                                for (var p = 1, q = l[0].rows.length, r = d.expColInd, s = d.treeReader.leaf_field, t = d.treeReader.expanded_field; p < q;) $(l[0].rows[p].cells[r]).find("div.treeclick").on("click", function(a) {
                            ...
                            d.multiselect && $.each(d.selarrrow, function() {
                                ...
                                inlineNav: !1
                            }), l.jqGrid("inlineNav", d.pager, g)), d.filterToolbar && h && (l.jqGrid("setGridParam", {
                                filterToolbar: !1
                            }), h.restoreFromFilters = !0, l.jqGrid("filterToolbar", h)), d.frozenColumns && l.jqGrid("setFrozenColumns"), l[0].updatepager(!0, !0), $.isFunction(c.afterSetGrid) && c.afterSetGrid(l), c.clearAfterLoad && (window[c.storageType].removeItem("jqGrid" + i.id), window[c.storageType].removeItem("jqGrid" + i.id + "_data"))
            ...
            jqGridExport: function(a) {
                ...
                return this.each(function() {
                    if (this.grid) {
                        ...
                        switch (c.rownumbers && (c.colNames.splice(0, 1), c.colModel.splice(0, 1)), c.multiselect && (c.colNames.splice(0, 1), c.colModel.splice(0, 1)), c.subGrid && (c.colNames.splice(0, 1), c.colModel.splice(0, 1)), c.knv = null, a.exptype) {
                            case "xmlstring":
                ...
                if (void 0 === x && (x = !0), x) {
                    if (l = $(o).attr("editable"), i.url = i.url || j.p.editurl, "1" === l) {
                        ...
                        if ($('td[role="gridcell"]', o).each(function(a) {
                            ...
                            try {
                                if ($.isFunction(j.p.validationCell)) j.p.validationCell.call(j, A, n[1], o.rowIndex, z);
                                else {
                        ...
                        var D, E = j.p.prmNames,
                            F = a;
                        if (D = !1 === j.p.keyName ? E.id : j.p.keyName, q) {
                            if (q[E.oper] = E.editoper, void 0 === q[D] || "" === q[D]) q[D] = a;
                        ...
                        if ("clientArray" === i.url) {
                            ...
                            for ($(o).attr("editable", "0"), J = 0; J < j.p.savedRow.length; J++)
                                if (String(j.p.savedRow[J].id) === String(F)) {
                                    m = J;
                                    break
                                }
                            m >= 0 && j.p.savedRow.splice(m, 1), $(j).triggerHandler("jqGridInlineAfterSaveRow", [a, K, q, i]), $.isFunction(i.aftersavefunc) && i.aftersavefunc.call(j, a, K, q, i), p = !0, $(o).removeClass("jqgrid-new-row").off("keydown")
                            ...
                            complete: function(b, c) {
                                if ($(j).jqGrid("progressBar", {
                                    ...
                                    if (d = $(j).triggerHandler("jqGridInlineSuccessSaveRow", [b, a, i]), $.isArray(d) || (d = [!0, s]), d[0] && $.isFunction(i.successfunc) && (d = i.successfunc.call(j, b)), $.isArray(d) ? (f = d[0], q = d[1] || q) : f = d, !0 === f) {
                                        ...
                                        m >= 0 && j.p.savedRow.splice(m, 1), $(j).triggerHandler("jqGridInlineAfterSaveRow", [a, b, q, i]), $.isFunction(i.aftersavefunc) && i.aftersavefunc.call(j, a, b, q, i), p = !0, $(o).removeClass("jqgrid-new-row").off("keydown")
                ...
                return b = $.extend(!0, {
                    ...
                    if (this.grid && !this.p.inlineNav) {
                        ...
                        b.add && $(c).jqGrid("navButtonAdd", a, {
                            ...
                            c.p.savedRow.length > 0 && !0 === c.p.inlineNav && d !== c.p.selrow && null !== c.p.selrow && (c.p.selrow === b.addParams.rowID ? $(c).jqGrid("delRowData", c.p.selrow) : !0 === b.restoreAfterSelect ? $(c).jqGrid("restoreRow", c.p.selrow, b.editParams) : $(c).jqGrid("saveRow", c.p.selrow, b.editParams), $(c).jqGrid("showAddEditButtons"))
                        })
                    }
                })
            },
    ...
    $.jgrid.extend({
                            ...
                            drop: function(a) {
                                return $.extend({
                                    accept: function(a) {
                                        ...
                                        if (f = $(a).closest("table.ui-jqgrid-btable"), f.length > 0 && void 0 !== $.data(f[0], "dnd")) {
                                            var b = $.data(f[0], "dnd").connectWith;
                                    ...
                                    drop: function(b, c) {
                                        if ($(c.draggable).hasClass("jqgrow")) {
                                            ...
                                            if (c.helper.dropped = !0, $.data(f[0], "dnd").beforedrop && $.isFunction($.data(f[0], "dnd").beforedrop)) {
                                                var l = $.data(f[0], "dnd").beforedrop.call(this, b, c, e, $(f[0]), $(this));
                                                void 0 !== l && null !== l && "object" == typeof l && (e = l)
                                            }
                                            if (c.helper.dropped) {
                                                var m;
        ...
        pivotSetup: function(a, b) {
            ...
            return this.each(function() {
                ...
                function l(a, b, c, d, e) {
                    var f;
                    if ($.isFunction(a)) f = a.call(w, b, c, d);
                    else switch (a) {
                        case "sum":
                ...
                function m(a, b, c, e) {
                    ...
                    for ($.isArray(c) ? (k = c.length, r = c) : (k = 1, r[0] = c), f = [], g = [], f.root = 0, j = 0; j < k; j++) {
                        var t, u = [];
                        for (h = 0; h < o; h++) {
                            if (m = "string" == typeof b[h].aggregator ? b[h].aggregator : "cust", null == c) i = $.trim(b[h].member) + "_" + m, t = i, r[0] = b[h].label || m + " " + $.trim(b[h].member);
                            else {
                                t = c[j].replace(/\s+/g, "");
                                try {
                ...
                if (j.colTotals)
                    for (var P = d.length; P--;)
                        for (q = r; q < c.length; q++) O = c[q].name, e[O] ? e[O] += parseFloat(d[P][O] || 0) : e[O] = parseFloat(d[P][O] || 0);
                if (B > 0)
                    for (q = 0; q < B; q++) c[q].isGroupField && (h.groupingView.groupField.push(c[q].name), h.groupingView.groupSummary.push(j.groupSummary), h.groupingView.groupSummaryPos.push(j.groupSummaryPos));
                else h.grouping = !1;
            ...
            return this.each(function() {
                function e(a) {
                    ...
                    if (h = b.xDimension.length, c.sortname) {
                        for (e = c.sortorder ? c.sortorder : "asc", g = "text", d = 0; d < h; d++)
                ...
                if (c.grid) {
                    var d, e, f, g, h, i = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base,
                        ...
                        m = function(a, b) {
                            ...
                            if ($(m).append(n), a && (h = c.p.jsonReader.subgrid, void 0 !== (e = $.jgrid.getAccessor(a, h.root))))
                                for (f = 0; f < e.length; f++) {
                                    if (g = e[f], n = $("<tr class='" + j.content + " ui-subtblcell'></tr>"), !0 === h.repeatitems)
                    ...
                    var p, q = c.rows.length,
                        r = 1,
                        s = $.isFunction(c.p.isHasSubGrid);
                    ...
                    !0 === c.p.subGridOptions.expandOnLoad && $(c.rows).filter(".jqgrow").each(function(a, b) {
                        $(b.cells[0]).click()
        ...
        setTreeNode: function(a, b) {
            return this.each(function() {
                ...
                if (c.grid && c.p.treeGrid) {
                    var d, e, f, g, h, i, j, k, l = c.p.expColInd,
                        ...
                        r = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common,
                        s = a;
            ...
            this.each(function() {
                ...
                if (b.grid && b.p.treeGrid) {
                    var c = $(b).jqGrid("getNodeChildren", a),
                        ...
                        f = $(b).triggerHandler("jqGridBeforeExpandTreeGridRow", [e, a, c]);
                    void 0 === f && (f = !0), f && $.isFunction(b.p.beforeExpandTreeGridRow) && (f = b.p.beforeExpandTreeGridRow.call(b, e, a, c)), !1 !== f && ($(c).each(function() {
                    ...
                    }), $(b).triggerHandler("jqGridAfterExpandTreeGridRow", [e, a, c]), $.isFunction(b.p.afterExpandTreeGridRow) && b.p.afterExpandTreeGridRow.call(b, e, a, c))
                }
            })
        },
        ...
        setLeaf: function(a, b, c) {
            return this.each(function() {
                ...
                if (!0 === b) $("div.treeclick", e).removeClass(this.p.treeIcons.minus + " tree-minus " + this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.leaf + " tree-leaf");
                else if (!1 === b) {
            ...
            return this.each(function() {
                if (this.grid && this.p.treeGrid && h)
                    for (b = this.p.localReader.id; h--;)
                        if (i = $(this).jqGrid("getNodeAncestors", a[h], !0, !0), i.push(a[h]), c = i[0][b], -1 === $.inArray(c, j)) j.push(c), k = k.concat(i);
                        else
    ...
    $.fmatter = {}, $.extend($.fmatter, {
            ...
            if ($.fmatter.isNumber(a) || (a *= 1), $.fmatter.isNumber(a)) {
                ...
                if ($.fmatter.isNumber(b.decimalPlaces)) {
                    ...
                    if (e = String(Math.round(a * h) / h), c = e.lastIndexOf("."), g > 0)
                        for (c < 0 ? (e += f, c = e.length - 1) : "." !== f && (e = e.replace(".", f)); e.length - 1 - c < g;) e += "0"
                }
        ...
        if (void 0 !== b.colModel.formatoptions ? (e = b.colModel.formatoptions.value, c = void 0 === b.colModel.formatoptions.separator ? ":" : b.colModel.formatoptions.separator, d = void 0 === b.colModel.formatoptions.delimiter ? ";" : b.colModel.formatoptions.delimiter) : void 0 !== b.colModel.editoptions && (e = b.colModel.editoptions.value, c = void 0 === b.colModel.editoptions.separator ? ":" : b.colModel.editoptions.separator, d = void 0 === b.colModel.editoptions.delimiter ? ";" : b.colModel.editoptions.delimiter), e) {
            var g, h = !0 == (null != b.colModel.editoptions && !0 === b.colModel.editoptions.multiple),
                i = [];
        ...
        if (void 0 !== j && $.isFunction(j)) e = j.call(this, $(a).text(), b, a);
            ...
            switch (g) {
                ...
                case "currency":
                    ...
                    break;
                case "checkbox":
                    var m = b.colModel.editoptions ? b.colModel.editoptions.value.split(":") : ["Si", "No"];
    ...
    $.fn.html5sortable = function(a) {
        ...
        xmlToZip: function(a, b) {
            var c, d, e, f, g, h, i = this,
                ...
                l = [];
            $.each(b, function(b, m) {
                if ($.isPlainObject(m)) c = a.folder(b), i.xmlToZip(c, m);
                else {
                    if (k) {
                        for (d = m.childNodes[0], e = d.attributes.length - 1; e >= 0; e--) {
                            var n = d.attributes[e].nodeName,
                                o = d.attributes[e].nodeValue; - 1 !== n.indexOf(":") && (l.push({
                                name: n,
                                value: o
                            }), d.removeAttribute(n))
                        }
            ...
            if (this.each(function() {
                    function c(a, b) {
                        ...
                        function d(a, d, e, f) {
                            var g, h, l = c(a, d, e),
                                m = l.cnt,
                                n = new Array(b.collen),
                                o = 0;
                            for (h = f; h < k; h++)
                                if (!j[h].hidden) {
                                    var p = "{0}";
                                    $.each(l.summary, function() {
                                        if (this.nm === j[h].name) {
                                            j[h].summaryTpl && (p = j[h].summaryTpl), "string" == typeof this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && m > 0 && (this.v = this.v / m));
                                            try {
                                                this.groupCount = l.cnt, this.groupIndex = l.dataIndex, this.groupValue = l.value, g = i.formatter("", this.v, h, this)
                                            } catch (a) {
                                                g = this.v
                                            }
                        ...
                        var m, n, o = $.makeArray(f.groupSummary);
                        return o.reverse(), $.each(f.groups, function(c, k) {
                            l++;
                            try {
                                m = $.isArray(f.formatDisplayField) && $.isFunction(f.formatDisplayField[k.idx]) ? f.formatDisplayField[k.idx].call(i, k.displayValue, k.value, i.p.colModel[g[k.idx]], k.idx, f) : i.formatter("", k.displayValue, g[k.idx], k.value)
                            } catch (a) {
                                m = k.displayValue
                            }
                            var p = "";
                            "string" != typeof(p = $.isFunction(f.groupText[k.idx]) ? f.groupText[k.idx].call(i, m, k.cnt, k.summary) : $.jgrid.template(f.groupText[k.idx], m, k.cnt, k.summary)) && "number" != typeof p && (p = m);
                            var q;
                            if (q = "header" === f.groupSummaryPos[k.idx] ? d(c, 0, f.groups, 0) : new Array(b.collen), q[0] = $.jgrid.formatCellCsv($.jgrid.stripHtml(p), b), e += q.join(b.separator) + b.newLine, h - 1 === k.idx) {
                                var r, s, t, u = f.groups[c + 1],
                                    v = 0,
                                    w = k.startRow,
                                    x = void 0 !== u ? u.startRow : f.groups[c].startRow + f.groups[c].cnt;
                                for (r = w; r < x && a[r - v]; r++) {
                                    for (t = a[r - v], n = 0, s = 0; s < j.length; s++) j[s].hidden || (q[n] = $.jgrid.formatCellCsv($.jgrid.formatCell(t[j[s].name], s, t, j[s], i, "csv"), b), n++);
                                    e += q.join(b.separator) + b.newLine
                                }
                                if ("header" !== f.groupSummaryPos[k.idx]) {
                                    var y;
                                    if (void 0 !== u) {
                                        for (y = 0; y < f.groupField.length && u.dataIndex !== f.groupField[y]; y++);
                                        l = f.groupField.length - y
                                    }
                                    for (s = 0; s < l; s++) o[s] && (q = d(c, s, f.groups, 0), e += q.join(b.separator) + b.newLine);
                                    l = y
                                }
                            }
                        }), e
                    ...
                    if ($.each(l, function(b, c) {
                            void 0 === c.exportcol && (c.exportcol = !0), "cb" !== c.name && "rn" !== c.name || c.hidden || (v.push(b), c.hidden = !0), c.exportcol || c.hidden || (x.push(b), c.hidden = !0), !c.hidden && c.exportcol && (u.push($.jgrid.formatCellCsv(n[b], a)), w.push(c.name))
                        }), a.includeLabels && (t = u.join(a.separator) + a.newLine), a.collen = u.length, i.p.grouping) p += c(j, a);
                    else
                        for (; o < k;) {
                            for (e = j[o], f = [], g = 0, d = 0; d < m; d++) l[d].hidden || (f[g] = $.jgrid.formatCellCsv($.jgrid.formatCell(e[l[d].name], d, e, l[d], i, "csv"), a), g++);
                    ...
                    if (a.includeGroupHeader && i.p.groupHeader && i.p.groupHeader.length) {
                        var y = i.p.groupHeader;
                        for (d = 0; d < y.length; d++) {
                            var z = y[d].groupHeaders;
                            for (o = 0, f = [], h = 0; h < w.length; h++) {
                                for (f[o] = "", g = 0; g < z.length; g++) z[g].startColumnName === w[h] && (f[o] = $.jgrid.formatCellCsv(z[g].titleText, a));
                                o++
                            }
                    ...
                    if (a.includeFooter && i.p.footerrow) {
                        var A = $(".ui-jqgrid-ftable", this.sDiv);
                        if (A.length) {
                            var B = A[0].rows[0];
                            for (d = 0, o = 0, f = []; d < B.cells.length;) {
                                var C = B.cells[d],
                                    D = $(C).attr("aria-describedby").slice(-3);
                                C.hidden || "_cb" === D || "_rn" === D || (f[o] = $.jgrid.formatCellCsv($(C).text(), a), o++), d++
                            }
                            s += f.join(a.separator) + a.newLine
                        }
                    }
                    for (b = q + r + t + p + s, d = 0; d < v.length; d++) l[v[d]].hidden = !1;
                    for (d = 0; d < x.length; d++) l[x[d]].hidden = !1
        ...
        exportToExcel: function(a) {
            a = $.extend(!0, {
                ...
                function c(a) {
                    ...
                    m.reverse(), $.each(e.groups, function(b, i) {
                        j++;
                        try {
                ...
                var d, e, f = this,
                    g = $.jgrid.excelStrings,
                    h = 0,
                    i = $.parseXML(g["xl/worksheets/sheet1.xml"]),
                ...
                for (d = 0, e = l.length; d < e; d++) void 0 === l[d].exportcol && (l[d].exportcol = !0), !l[d].hidden && "cb" !== l[d].name && "rn" !== l[d].name && l[d].exportcol && (n.header[m] = l[d].name, n.width[m] = 5, n.map[m] = d, m++);
                var o, p, q = $.isFunction(a.replaceStr) ? a.replaceStr : b,
                    r = function(b, c) {
                        o = h + 1, p = $.jgrid.makeNode(i, "row", {
                            attr: {
                                r: o
                            }
                        });
                        for (var d = 0; d < n.header.length; d++) {
                            var e, g = $.jgrid.excelCellPos(d) + "" + o,
                                k = $.isArray(b) && c ? f.p.colNames[n.map[d]] : b[n.header[d]];
                            if (null == k && (k = ""), c || (k = "" !== k ? $.jgrid.formatCell(k, n.map[d], b, l[n.map[d]], f, "excel") : k), n.width[d] = Math.max(n.width[d], Math.min(parseInt(k.toString().length, 10), a.maxlength)), "number" == typeof k || k.match && $.trim(k).match(/^-?\d+(\.\d+)?$/) && !$.trim(k).match(/^0\d+/)) e = $.jgrid.makeNode(i, "c", {
                                attr: {
                                    t: "n",
                                    r: g
                                },
                                ...
                                var m = k.replace ? q(k) : k;
                                e = $.jgrid.makeNode(i, "c", {
                                    attr: {
                                        t: "inlineStr",
                                        r: g
                                    },
                ...
                if ($("sheets sheet", k.xl["workbook.xml"]).attr("name", a.sheetName), a.includeGroupHeader && f.p.groupHeader && f.p.groupHeader.length) {
                    ...
                    for ($("worksheet", i).append(C), m = 0; m < v.length; m++) C.appendChild($.jgrid.makeNode(i, "mergeCell", {
                        attr: v[m]
                    }))
                }
                if (a.includeLabels && (r(n.header, !0), $("row:last c", i).attr("s", "2")), f.p.grouping) c(n.body);
                else
                    for (var D = 0, E = n.body.length; D < E; D++) r(n.body[D], !1);
                ...
                var F = $.jgrid.makeNode(i, "cols");
                for ($("worksheet", i).prepend(F), m = 0, e = n.width.length; m < e; m++) F.appendChild($.jgrid.makeNode(i, "col", {
                    attr: {
                        min: m + 1,
                        max: m + 1,
                        width: n.width[m],
                ...
                try {
                    ...
                    $.jgrid.xmlToZip(G, k), G.generateAsync ? G.generateAsync(H).then(function(b) {
                        $.jgrid.saveAs(b, a.fileName, {
                            type: a.mimetype
                        })
                    }) : $.jgrid.saveAs(G.generate(H), a.fileName, {
                        type: a.mimetype
                    })
                } catch (a) {
                    throw a
        ...
        exportToPdf: function(a) {
            return a = $.extend(!0, {
                ...
                function b(a) {
                    ...
                    u.reverse(), $.each(f.groups, function(c, j) {
                        s++;
                        try {
                ...
                var c, d, e, f, g = this,
                    ...
                    p = [],
                    q = {};
                for (c = 0, d = i.length; c < d; c++) void 0 === i[c].exportcol && (i[c].exportcol = !0), !i[c].hidden && "cb" !== i[c].name && "rn" !== i[c].name && i[c].exportcol && (j = {
                    text: g.p.colNames[c],
                    style: "tableHeader"
                ...
                if (a.includeGroupHeader && g.p.groupHeader && g.p.groupHeader.length)
                    for (r = g.p.groupHeader, m = 0; m < r.length; m++) {
                        var s = [],
                            t = r[m].groupHeaders;
                ...
                if (a.includeLabels && h.push(o), g.p.grouping) b(k);
                else {
                    var u;
                    for (m = 0, d = k.length; m < d; m++) {
                        for (f = 0, o = [], u = k[m], e = 0; e < l.length; e++) j = {
                            text: null == u[l[e]] ? "" : $.jgrid.formatCell(u[l[e]] + "", n[f], k[m], i[n[f]], g, "pdf"),
                            alignment: q[l[e]],
                            style: "tableBody"
                        }, o.push(j), f++;
                        h.push(o)
                ...
                if (a.includeFooter && g.p.footerrow) {
                    var v = $(g).jqGrid("footerData", "get");
                    for (o = [], e = 0; e < l.length; e++) j = {
                        text: $.jgrid.stripHtml(v[l[e]]),
                        style: "tableFooter",
                        alignment: q[l[e]]
                    }, o.push(j);
                    h.push(o)
                ...
                a.description && w.content.unshift({
                    text: a.description,
                    style: "description",
                    margin: [0, 0, 0, 12]
                }), a.title && w.content.unshift({
                    text: a.title,
                    style: "title",
                    margin: [0, 0, 0, 12]
                }), $.isFunction(a.onBeforeExport) && a.onBeforeExport.call(g, w);
                try {
                    var x = pdfMake.createPdf(w);
                    "open" === a.download ? x.open() : x.getBuffer(function(b) {
                        $.jgrid.saveAs(b, a.fileName, {
                            type: a.mimetype
                        })
                    })
