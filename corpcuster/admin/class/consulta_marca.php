...
if(!isset($_POST['user']))
{
   $sql="select a.id,a.descricpcion, a.estado,a.fecha_registro from marca a; ";
}
else
{
   $sql="select a.id,a.descricpcion, a.estado,a.fecha_registro from marca a where a.id='".$_POST["user"]."';";   
} 
