            ...
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                     <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                       ...
                       <li id="export" class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="ace-icon fa fa-cog"></i></a>
                       <ul class="dropdown-menu" role="menu">
                          <li><a id="pdf" href="#">Descargar Pdf</a>
                          </li>
                          <li><a id="excel" href="#">Descargar Excel</a>
                          </li>
                          <li><a id="csv" href="#">Descargar CSV</a>
...
columnausuario={name: 'usuario',index: 'usuario',width: 100,editable: true,frozen : false,editrules:{custom_func: validateRequerid,custom: true},editoptions: {size: "20",maxlength: "20"}
        ...
        jQuery(grid_selector).jqGrid({
            ...
            colNames: [' ', 'IdUser', "Usuario",'Nombre','Pass','Correo','Rol','Empresa','Activo'],
            colModel: [{
                    name: 'myac',
                    index: '',
                    width: 80,
                   ...
                   left: 500,
                    formatoptions: {
                        keys: true,
                        delbutton: _OpeDelete,//disable delete button
...
//            rownumWidth: 25, // the width of the row numbers columns
       ...
       /* $(grid_selector).navButtonAdd(pager_selector,
        ...
        jQuery(grid_selector).jqGrid('navGrid', pager_selector, { //navbar options
           ...
           /* errorTextFormat: function (data) {
                        _MensajeNotificacion("Error",data.responseText,"error","S")
                    },*/
      ...
      function getObjects(obj, key, val) {
        ...
        <input type="radio" name="lang" onclick="navigateToLang('kr')">Korean<br><br /><br />*/

          function navigateToLang(lng) {
            $.jgrid.setRegional('grid_table',{regional: lng});
        }
