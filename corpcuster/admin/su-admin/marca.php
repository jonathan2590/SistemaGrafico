...
<div id="myModalA" title="Editar Marca" style="overflow-x: hidden;" style="display:none;">
<form action="edito-marca.php" method="post" enctype="multipart/form-data" name="form_editar">
...
<div id="myModalB" title="Agregar Marca" style="overflow-x: hidden;" style="display:none;">
<form action="agrego-marca.php" method="post" enctype="multipart/form-data" name="form_agregar">
<table>
    <tr>
...
if (nombre.trim()=='')
  {
    mensajerror("Ingresar la Marca");
    return false;
  }

     BootstrapDialog.show({
                                title: 'Actualización de la Marca',
                                ...
                                buttons: [{
                                    ...
                                    $.ajax({     data: {"usuario" : jQuery("#codigo").val()  ,marca: jQuery("#nombre").val(),codigomarca: jQuery("#codigo_e").val(),select_estado:jQuery("#select_estado_a").val() },
                                                 type: "POST",
                                                  dataType: "json",
                                                  url: "edito-marca.php",
                                                    })
                                                 .done(function( response ) {
                                                  if( response.success ) 
                                                  {
                                                       if ( console && console.log ) 
                                                       {
                                                           ...
                                                           mensaje('Se modifico Correctamente la Marca: ' + jQuery("#nombre").val());
                                                           dialog.dialog("close");
                                                           listar_marca();//location.reload(true)
                                                      }
                                                   } 
                                                   else 
                                                   {
                                         ...
                                         .fail(function( jqXHR, textStatus, errorThrown ) {
                                                 mensaje('Se modifico Correctamente el Marca: ' + jQuery("#nombre").val());
                                                           dialog.dialog("close");
                                                           listar_marca();
                                          })
                                    dialogRef.close();
                                                 ...
                                                 .done(function( response ) {
                                                  if( response.success ) 
                                                  {
                                                       if ( console && console.log ) 
                                                       {
                                                           ...
                                                           mensaje('Se Agrego Correctamente la Marca: ' + jQuery("#nombre_a").val());
...
//se inicializa el documento
 jQuery(document).ready(function() {
  ...
  jQuery("#codigo_a").change(function()
    {
var mensaje="";
mensaje="El código de marca " + this.value + " ya existe";
                                                 ...
                                                 .done(function( response ) {
                                                  if( response.success ) 
                                                  {
                                                       if ( console && console.log ) 
                                                       {
                                                           ...
                                                           mensaje('Se Elimino Correctamente la Marca: ' + data[1]);
                                                           listar_marca();//location.reload(true)
                                                      }
                                                   } 
                                                   else 
