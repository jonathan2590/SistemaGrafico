...
<div id="myModalA" title="Editar País" style="overflow-x: hidden;" style="display:none;">
<form action="edito-pais.php" method="post" enctype="multipart/form-data" name="form_editar">
...
<div id="myModalB" title="Agregar País" style="overflow-x: hidden;" style="display:none;">
<form action="agrego-pais.php" method="post" enctype="multipart/form-data" name="form_agregar">
<table>
    <tr>
...
if (nombre.trim()=='')
  {
    mensajerror("Introduccir el nombre del País");
    return false;
  }

     BootstrapDialog.show({
                                title: 'Actualización de País',
                                ...
                                buttons: [{
                                    ...
                                    $.ajax({     data: {"usuario" : jQuery("#codigo").val()  ,pais: jQuery("#nombre").val(),codigopais: jQuery("#codigo_e").val(),select_estado:jQuery("#select_estado_a").val() },
                                                 type: "POST",
                                                  dataType: "json",
                                                  url: "edito-pais.php",
                                                    })
                                                 .done(function( response ) {
                                                  if( response.success ) 
                                                  {
                                                       if ( console && console.log ) 
                                                       {
                                                           ...
                                                           mensaje('Se modifico Correctamente el País: ' + jQuery("#nombre").val());
                                                           dialog.dialog("close");
                                                           listar_pais();//location.reload(true)
                                                      }
                                                   } 
                                                   else 
                                                   {
...
if (nombre.trim()=='')
  {
    mensajerror("Introduccir el Nonbre del País");
    return false;
  }
                                                 ...
                                                 .done(function( response ) {
                                                  if( response.success ) 
                                                  {
                                                       if ( console && console.log ) 
                                                       {
                                                           ...
                                                           mensaje('Se Agrego Correctamente el País: ' + jQuery("#nombre_a").val());
...
//se inicializa el documento
 jQuery(document).ready(function() {
  ...
  jQuery("#codigo_a").change(function()
    {
var mensaje="";
mensaje="El código país " + this.value + " ya existe";

$.ajax({
                     
                     type: "POST",
                      dataType: "json",
                      data: {codigopais : this.value},  
                      url: "../class/consulta_pais.php",
                        })
                     .done(function( response ) {
                                                 ...
                                                 .done(function( response ) {
                                                  if( response.success ) 
                                                  {
                                                       if ( console && console.log ) 
                                                       {
                                                           ...
                                                           mensaje('Se Elimino Correctamente el País: ' + data[1]);
                                                           listar_pais();//location.reload(true)
                                                      }
                                                   } 
                                                   else 
